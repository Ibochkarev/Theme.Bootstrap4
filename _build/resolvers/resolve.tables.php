...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('theme.bootstrap4_core_path', null, $modx->getOption('core_path') . 'components/theme.bootstrap4/') . 'model/';
            $modx->addPackage('theme.bootstrap4', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/theme.bootstrap4/model/schema/theme.bootstrap4.mysql.schema.xml';
