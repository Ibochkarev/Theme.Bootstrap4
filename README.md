...
Theme.Bootstrap4 is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/Theme.Bootstrap4.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory Theme.Bootstrap4 is now in, and do this:
...
Now, you'll want to change references to Theme.Bootstrap4 in the files in your
new copied-from-Theme.Bootstrap4 repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'Theme.Bootstrap4' to whatever the
name of your component is.

## Copyright Information

Theme.Bootstrap4 is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of Theme.Bootstrap4 the ability to modify, distribute
and use Theme.Bootstrap4 in MODx development as they see fit, as long as attribution
